...
var WETH =
  ...
  (_WETH[ChainId.KOVAN] = /*#__PURE__*/ new Token(
    ChainId.KOVAN,
    "0x55De1148A702BdEEa07eDbCD3C9F263Ff4e60382",
    18,
    "WETH",
    "Wrapped Ether"
  )),
  (_WETH[ChainId.MATICTESTNET] = /*#__PURE__*/ new Token(
...
var Fetcher = /*#__PURE__*/ (function () {
    ...
    try {
      ...
      return Promise.resolve(
        _temp4
          ...
          : Promise.resolve(
              new Contract(address, ERC20, provider)
                .decimals()
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(
        new Contract(address, IUniswapV2Pair.abi, provider).getReserves()
      ).then(function (_ref) {
