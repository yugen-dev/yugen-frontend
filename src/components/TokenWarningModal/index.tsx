...
import { getMaticExplorerLink, shortenAddress } from '../../utils'
    ...
    <Wrapper error={duplicateNameOrSymbol}>
      <AutoRow gap="6px">
        ...
        <AutoColumn gap="10px" justify="flex-start">
          ...
          {chainId && (
            <ExternalLink style={{ fontWeight: 400 }} href={getMaticExplorerLink(chainId, token.address, 'token')}>
              <Text title={token.address}>
                {shortenAddress(token.address)} {TranslateString(116, '(View on MaticExplorer)')}
              </Text>
            </ExternalLink>
          )}
        </AutoColumn>
