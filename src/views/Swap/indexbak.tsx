...
import { CardBody, ArrowDownIcon, Button, IconButton, Text, HelpIcon } from 'cryption-uikit'
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                  ...
                  <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '0 1rem' }}>
                    <ArrowWrapper clickable>
                      <IconButton
                        ...
                        style={{ borderRadius: '50%', background: '#929090' }}
                        scale="sm"
                      >
                        <ArrowDownIcon color="#4E51F2" width="24px" />
                      </IconButton>
                    </ArrowWrapper>
      ...
      <div className="info-container">
        <div className="info-item">
          <span>
            Minimum received
            <HelpIcon color="#707070" width="16px" style={{ marginLeft: '5px', cursor: 'pointer' }} />
          </span>
          <span>1.323 DOT</span>
        </div>
        <div className="info-item">
