    ...
    <StyledCakeStats>
      <CNCardBody>
        ...
        <Row>
          ...
          {cakeSupply && <CardValue fontSize="14px" value={cakeSupply} bold color="#686B7A" />}
        </Row>
        <Row>
          <Text fontSize="14px" bold color="#686B7A">
            {TranslateString(538, "Total CAKE Burned")}
          </Text>
          <CardValue fontSize="14px" decimals={0} value={burnedBalance} bold color="#686B7A"/>
        </Row>
        <Row>
          <Text fontSize="14px" bold color="#686B7A">{TranslateString(540, "New CAKE/block")}</Text>
          <CardValue fontSize="14px" decimals={0} value={25} bold color="#686B7A" />
        </Row>
      </CNTable>
      </CNCardBody>
    </StyledCakeStats>
